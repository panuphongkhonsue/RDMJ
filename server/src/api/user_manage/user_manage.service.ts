...
export const get_user = (
  ...
  database.query(
    ...
    "WHERE (rdmj_work_time_edit.wte_date_on_change  IN  " +
    "(SELECT max(rdmj_work_time_edit.wte_date_on_change) FROM rdmj_work_time_edit GROUP BY wte_user_id ) or wte_status_change is null) " +
    "and user.name like ?" +
